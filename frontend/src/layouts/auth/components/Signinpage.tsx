...
export const Signinpage = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.userType === 'hospital-admin') {
      ...
      if (!formData.hospitalPhone1) {
        newErrors.hospitalPhone1 = 'Hospital phone number is required';
      } else if (!/^\+?[\d\s-()]+$/.test(formData.hospitalPhone1)) {
        newErrors.hospitalPhone1 = 'Hospital phone number is invalid';
      }

      if (formData.hospitalPhone2 && !/^\+?[\d\s-()]+$/.test(formData.hospitalPhone2)) {
      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-2/5 flex-col justify-center items-center p-12 relative overflow-hidden">
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center">
            ...
            >
              <div className={`p-6 rounded-3xl ${themeClasses.accent.gradient} shadow-2xl`}>
            ...
            >
              ...
              <p className={`text-xl ${themeClasses.text.secondary} leading-relaxed max-w-md`}>
                Join our revolutionary healthcare management platform and transform how you manage medical operations.
              </p>
            </motion.div>
            ...
            >
              {[
                { icon: <Hospital className="w-5 h-5" />, text: "Multi-hospital management" },
                { icon: <User className="w-5 h-5" />, text: "Role-based access control" },
                { icon: <Globe className="w-5 h-5" />, text: "City-wide connectivity" }
              ].map((feature, index) => (
                <div key={index} className="flex items-center space-x-3 text-left">
                  <div className={`p-2 rounded-lg ${themeClasses.accent.light}`}>
                    <div className={themeClasses.text.accent}>
                      {feature.icon}
                    </div>
                  </div>
                  <span className={`${themeClasses.text.secondary}`}>{feature.text}</span>
                </div>
              ))}
            </motion.div>
          </div>
        ...
        <div className="w-full lg:w-1/2 xl:w-3/5 flex flex-col max-h-screen">
          ...
          <div className="flex-1 overflow-y-auto px-6 lg:px-12 pb-6 lg:pb-12">
            ...
            <div>
              ...
              <div className="relative">
                <Phone className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 ${themeClasses.text.secondary}`} />
                <input
                  type="tel"
                  name="phone"
            ...
            {/* Hospital Admin Specific Fields */}
            {formData.userType === 'hospital-admin' && (
              <motion.div
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    <Building2 className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 ${themeClasses.text.secondary}`} />
                    <input
                      type="text"
                      name="hospitalName"
                ...
                <div>
                  ...
                  <div className="relative">
                    <MapPin className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 ${themeClasses.text.secondary}`} />
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <FileText className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 ${themeClasses.text.secondary}`} />
                      <input
                        type="text"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 ${themeClasses.bg.secondary} ${themeClasses.border.primary} border rounded-lg ${themeClasses.text.primary} focus:outline-none focus:ring-2 focus:ring-offset-2 ${isDark ? 'focus:ring-blue-500' : 'focus:ring-green-500'} transition-all`}
                    >
            ...
            <div>
              <label className="flex items-start space-x-3">
                <input
                  ...
                  onChange={handleInputChange}
                  className={`mt-1 rounded ${themeClasses.accent.primary} text-white focus:ring-2 ${isDark ? 'focus:ring-blue-500' : 'focus:ring-green-500'}`}
                />
                <span className={`text-sm ${themeClasses.text.secondary} leading-relaxed`}>
                  I agree to the{' '}
                  <Link to="/terms" className={`${themeClasses.text.accent} hover:underline`}>
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className={`${themeClasses.text.accent} hover:underline`}>
                    Privacy Policy
                  </Link>
                </span>
              </label>
